...
def load_dataset(args, tokenizer, is_training=True, output_examples=False):
    ...
    #     cached_examples_file = "data/2.1/cached_examples_test_SA_sp_2.1"
    #     cached_features_file = "data/2.1/cached_features_test_SA_sp_2.1"
    ...
    slots_input = get_slot_input_ids(tokenizer, args.dataset_version, False)
